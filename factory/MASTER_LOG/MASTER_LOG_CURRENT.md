...
- 진행 중: Savingio 인생 지도형 글 연결 리모델 2차까지 누적 100개 적용·검증 완료. 전체 220개 대상은 50개 단위 5개 배치로 고정했다.
- 다음 실행 위치: `python -m factory.article_connection_batch --project-root . --batch 3 --batch-size 50 --apply`
