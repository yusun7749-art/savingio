...
| 검색 의도 그룹 | 대표 URL | 처리 | 통합·정리 대상 URL | 상태 |
|---|---|---|---|---|
...
| 사업용 차량 비용처리 | `/articles/business-vehicle-expense-basics.html` | KEEP | 없음 | 유지 |
| 자동차보험 과납 환급 | `/articles/car-insurance-overpayment-refund.html` | KEEP | 없음 | 유지 |
| 교통 과태료·범칙금 | `/articles/traffic-fines-difference-guide.html` | KEEP | 기존 중복 URL 2개 | 301 완료 |

## 통합 완료

| 제거 URL | 대표 URL | 처리 |
|---|---|---|
| `/articles/car-insurance-low-mileage-discount.html` | `/articles/car-insurance-mileage-refund.html` | 301 완료 |
| `/articles/fuel-saving-driving-habits.html` | `/articles/car-aircon-fuel-saving.html` | 301 완료 |
| `/articles/traffic-fine-check-payment-guide.html` | `/articles/traffic-fines-difference-guide.html` | 301 완료 |
| `/articles/traffic-penalty-check-payment-guide.html` | `/articles/traffic-fines-difference-guide.html` | 301 완료 |
