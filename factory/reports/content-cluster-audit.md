...
- `articles/aircon-optimal-temperature-savings.html` — 에어컨 적정 온도는 몇 도일까? 전기요금과 쾌적함을 함께 잡는 설정 순서 (8,682자)
...
- `articles/vat-input-tax-deduction-2026.html` — 부가가치세 매입세액 공제·불공제 판단법 2026 (4,618자)
...
- `articles/long-term-repair-reserve-refund-guide.html` — 장기수선충당금은 누가 내고, 세입자는 어떻게 돌려받나요? (1,489자)
...
- `articles/insurance-auto-pay-discount.html` — 보험료 자동이체 할인, 바꾸기 전에 실제 납부액부터 비교하세요 (4,516자)
...
- `articles/low-income-cooling-support.html` — 저소득층 냉방비 지원 신청 방법, 2026 에너지바우처 대상과 금액 (5,603자)
