(() => {
  ...
  const expectedModules=Object.freeze([
    ...
    'tool-search-console','tool-adsense','tool-github-release','dept-content','dept-seo','dept-qa'
  ]);
  const expectedGlobals=Object.freeze([
    ...
    'SavingioV2SeoInventoryStore','SavingioV2QaInventoryStore','SavingioV2RuntimeAudit','SavingioAdminV2','SavingioV2ProductionAutoVerify'
  ]);
