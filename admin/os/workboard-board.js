(() => {
  ...
  const workboard = {
    ...
    currentTask: '7-03 GitHub·Cloudflare·URL 통합 모니터',
    phases: [
      ...
      { id:'phase-4', title:'Phase 4 — Automation Engine', tasks:[
        ['4-01','승인 후 GitHub 작업 생성 검증','done'],['4-02','GitHub 반영 상태 확인 검증','done'],['4-03','Cloudflare 배포 상태 확인 검증','done'],['4-04','실제 URL 검증','done'],['4-05','실패 자동 기록·재시도','done'],['4-06','다음 작업 자동 생성','done'],['4-07','전체 중지·부분 재실행','done'],['4-08','Automation Engine QA','done']
      ]},
      ...
      { id:'phase-7', title:'Phase 7 — Operations HQ', tasks:[
        ['7-01','운영 대시보드 Home HQ','done'],['7-02','전체 프로젝트 실시간 상태판','done'],['7-03','GitHub·Cloudflare·URL 통합 모니터','active'],['7-04','QA 결과 통합 패널','todo'],['7-05','오류 알림 센터','todo'],['7-06','승인 대기 작업함','todo'],['7-07','최근 배포 이력','todo'],['7-08','검색·필터·통합 로그 뷰어','todo'],['7-09','Operations HQ QA','todo']
      ]}
    ],
