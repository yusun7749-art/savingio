(() => {
  ...
  const workboard = {
    ...
    currentTask: '6-03 Plugin 설정 페이지',
    phases: [
      ...
      { id:'phase-6', title:'Phase 6 — Plugin Marketplace', tasks:[
        ['6-01','Plugin Marketplace','done'],['6-02','Plugin 설치·업데이트 UI','done'],['6-03','Plugin 설정 페이지','active'],['6-04','Plugin 백업·복원','todo'],['6-05','Plugin 의존성 관리','todo'],['6-06','Plugin 자동 업데이트','todo'],['6-07','Plugin 서명·무결성 검사','todo'],['6-08','Plugin Marketplace QA','todo']
      ]}
    ],
