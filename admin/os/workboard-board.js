  ...
  const workboard = {
    ...
    phases: [
      ...
      { id:'phase-7', title:'Phase 7 — Operations HQ', tasks:[
        ['7-01','운영 대시보드 Home HQ','done'],['7-02','전체 프로젝트 실시간 상태판','done'],['7-03','GitHub·Cloudflare·URL 통합 모니터','done'],['7-04','QA 결과 통합 패널','done'],['7-05','오류 알림 센터','active'],['7-06','승인 대기 작업함','todo'],['7-07','최근 배포 이력','todo'],['7-08','검색·필터·통합 로그 뷰어','todo'],['7-09','Operations HQ QA','todo']
      ]}
    ],
