(() => {
  ...
  const workboard = {
    ...
    currentTask: '3-02 새 프로젝트 생성 화면 연결 검증',
    phases: [
      ...
      { id:'phase-3', title:'Phase 3 — Project Engine', tasks:[
        ['3-01','공통 Project Schema 검증','done'],['3-02','새 프로젝트 생성 화면 연결 검증','active'],['3-03','프로젝트와 Asset 연결','todo'],['3-04','프로젝트와 Workflow 연결','todo'],['3-05','프로젝트 상세 통합 화면','todo'],['3-06','프로젝트 복제·보관·복구','todo'],['3-07','프로젝트 검색·필터·정렬','todo'],['3-08','Project Engine QA','todo']
      ]},
