  ...
  const workboard = {
    ...
    phases: [
      ...
      { id:'phase-5', title:'Phase 5 — Plugin Store', tasks:[
        ['5-01','Plugin Manifest 규격','done'],['5-02','Plugin 설치·제거','done'],['5-03','메뉴·작업판 자동 생성','done'],['5-04','권한·데이터 격리','done'],['5-05','계산기 Plugin','done'],['5-06','심리테스트 Plugin','done'],['5-07','게임 Plugin','active'],['5-08','이미지 스토어 Plugin','todo'],['5-09','쿠폰·제휴 Plugin','todo'],['5-10','전자책·디지털 상품 Plugin','todo'],['5-11','Plugin Store QA','todo']
      ]}
    ],
