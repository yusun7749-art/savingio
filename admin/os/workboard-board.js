  ...
  const workboard = {
    ...
    phases: [
      ...
      { id:'phase-2', title:'Phase 2 — Workflow Engine', tasks:[
        ['2-01','Workflow Engine 기반 구축','done'],['2-02','Workflow Board 기반 구축','done'],['2-03','Workflow 실제 관리자 화면 검증','done'],['2-04','단계별 담당 본부 연결 검증','done'],['2-05','단계별 산출물 연결 검증','done'],['2-06','승인 이력 연결 검증','active'],['2-07','실행 로그 연결','todo'],['2-08','Workflow QA','todo']
      ]},
