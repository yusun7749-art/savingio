(() => {
  ...
  const rightRailData = {
    'earned-income-credit-status-check': {
      ...
      calculator: [['급여 실수령액 계산기', '/calculators/salary.html']],
    ...
    'car-insurance-child-discount': {
      ...
      calculator: [['할인 금액 계산기', '/calculators/discount.html']],
    ...
    'car-insurance-mileage-refund': {
      ...
      calculator: [['실제 연비 계산기', '/calculators/fuel-efficiency.html'], ['할인 금액 계산기', '/calculators/discount.html']],
    ...
    'business-vehicle-expense-basics': {
      ...
      calculator: [['실제 연비 계산기', '/calculators/fuel-efficiency.html'], ['부가세 계산기', '/calculators/vat.html'], ['원가율 계산기', '/calculators/cost-rate.html']],
    ...
    'insurance-auto-pay-discount': {
      ...
      calculator: [['보험료 할인 금액 계산기', '/calculators/discount.html']],
