(async()=>{
'use strict';
const VERSION='20260723-master20';
...
if(/^\/articles\/?(?:index(?:\.html)?)?$/.test(location.pathname)||new URLSearchParams(location.search).get('doctor')==='1'){
 if(!window.SavingioSiteDoctor)await addScript(`/js/savingio-site-doctor.js?v=${VERSION}`,'savingioSiteDoctor');
}
